...
<body>
    ...
    <div class="container-fluid">
        <div class="row mt-3">
                ...
                <nav>
                    <ul class="nav nav-pills flex-column mb-0 align-items-center" id="menu">
                        ...
                        <li class="nav-item rounded-2 my-2" <?=($tela == "UsuarioLinguagem"?"style='background-color: #36397B;'": "style='background-color: #686BA3'")?>>
                            <a href="TelaInicio.php?tela=UsuarioLinguagem" class="nav-link text-white text-center fs-5" style='width:13vw;'>UsuarioLinguagem</a>
                        </li>
                    </ul>
                </nav>
            </div>
            <div class="col-sm-10">
                <?php
                    include_once("TelaUsuarioLinguagem.php");
                ?>
            </div>
        </div>
    </div>
